...
static LANGINFO langinfo[] = 
	{  
		...
		{ LANGID_RUSSIAN, "Russian", "ru" },
		{ LANGID_ARABIC, "Arabic", "ar" },
		{ LANGID_UKRAINIAN, "Ukrainian", "uk" },
		{ LANGID_SWEDISH, "Swedish", "sv" },
		{ LANGID_ABKHAZIAN, "Abkhazian", "ab" },
		{ LANGID_AFAR, "Afar", "aa" },
		{ LANGID_AFRIKAANS, "Afrikaans", "af" },
		{ LANGID_AKAN, "Akan", "ak" },
		{ LANGID_ALBANIAN, "Albanian", "sq" },
		{ LANGID_AMHARIC, "Amharic", "am" },
		{ LANGID_ARAGONESE, "Argonese", "an" },
		{ LANGID_ARMENIAN, "Armenian", "hy" },
		{ LANGID_ASSAMESE, "Assamese", "as" },
		{ LANGID_AVARIC, "Avaric", "av" },
		{ LANGID_AVESTAN, "Avestan", "ae" },
		{ LANGID_AYMARA, "Aymara", "ay" },
		{ LANGID_AZERBAIJANI, "Azerbaijani", "az" },
		{ LANGID_BAMBARA, "Bambara", "bm" },
		{ LANGID_BASHKIR, "Bashkir", "ba" },
		{ LANGID_BASQUE, "Basque", "eu" },
		{ LANGID_BELARUSIAN, "Belarusian", "be" },
		{ LANGID_BENGALI, "Bengali", "bn" },
		{ LANGID_BISLAMA, "Bislama", "bi" },
		{ LANGID_BOSNIAN, "Bosnian", "bs" },
		{ LANGID_BRETON, "Breton", "br" },
		{ LANGID_BULGARIAN, "Bulgraian", "bg" },
		{ LANGID_BURMESE, "Burmese", "my" },
		{ LANGID_CATALAN, "Catalan", "ca" },
		{ LANGID_CHAMORRO, "Chamorro", "ch" },
		{ LANGID_CHECHEN, "Chechen", "ce" },
		{ LANGID_CHICHEWA, "Chichewa", "ny" },
		{ LANGID_SLAVONIC, "Slavonic", "cu" },
		{ LANGID_CHUVASH, "Chuvash", "cv" },
		{ LANGID_CORNISH, "Cornish", "kw" },
		{ LANGID_CORSICAN, "Corsican", "co" },
		{ LANGID_CREE, "Cree", "cr" },
		{ LANGID_CROATIAN, "Croatian", "hr" },
		{ LANGID_CZECH, "Czech", "cs" },
		{ LANGID_DANISH, "Danish", "da" },
		{ LANGID_DIVEHI, "Divehi", "dv" },
		{ LANGID_DUTCH, "Dutch", "nl" },
		{ LANGID_DZONGKHA, "Dzongkha", "dz" },
		{ LANGID_ESPERANTO, "Esperanto", "eo" },
		{ LANGID_ESTONIAN, "Estonian", "et" },
		{ LANGID_EWE, "Ewe", "ee" },
		{ LANGID_FAROESE, "Faroese", "fo" },
		{ LANGID_FIJIAN, "Fijian", "fj" },
		{ LANGID_FINNISH, "Finnish", "fi" },
		{ LANGID_FRISIAN, "Frisian", "fy" },
		{ LANGID_FULAH, "Fulah", "ff" },
		{ LANGID_GAELIC, "Gaelic", "gd" },
		{ LANGID_GALICIAN, "Galician", "gl" },
		{ LANGID_GANDA, "Ganda", "lg" },
		{ LANGID_GEORGIAN, "Georgian", "ka" },
		{ LANGID_GREEK, "Greek", "el" },
		{ LANGID_KALAALLISUT, "Kalaallisut", "kl" },
		{ LANGID_GUARANI, "Guarani", "gn" },
		{ LANGID_GUJARATI, "Gujarati", "gu" },
		{ LANGID_HAITIAN, "Haitian", "ht" },
		{ LANGID_HAUSA, "Hausa", "ha" },
		{ LANGID_HEBREW, "Hebrew", "he" },
		{ LANGID_HERERO, "Herero", "hz" },
		{ LANGID_HINDI, "Hindi", "hi" },
		{ LANGID_HIRIMOTU, "Hirimotu", "ho" },
		{ LANGID_HUNGARIAN, "Hungarian", "hu" },
		{ LANGID_ICELANDIC, "Icelandic", "is" },
		{ LANGID_IDO, "Ido", "io" },
		{ LANGID_IGBO, "Igbo", "ig" },
		{ LANGID_INDONESIAN, "Indonesian", "id" },
		{ LANGID_INUKTITUT, "Inuktitut", "iu" },
		{ LANGID_INUPIAQ, "Inupiaq", "ik" },
		{ LANGID_IRISH, "Irish", "ga" },
		{ LANGID_JAVANESE, "Javanese", "jv" },
		{ LANGID_KANNADA, "Kannada", "kn" },
		{ LANGID_KANURI, "Kanuri", "kr" },
		{ LANGID_KASHMIRI, "Kashmiri", "ks" },
		{ LANGID_KAZAKH, "Kazakh", "kk" },
		{ LANGID_KHMER, "Khmer", "km" },
		{ LANGID_KIKUYU, "Kikuyu", "ki" },
		{ LANGID_KINYARWANDA, "Kinyarwanda", "rw" },
		{ LANGID_KYRGYZ, "Kyrgyz", "ky" },
		{ LANGID_KOMI, "Komi", "kv" },
		{ LANGID_KONGO, "Kongo", "kg" },
		{ LANGID_KUANYAMA, "Kuanyama", "kj" },
		{ LANGID_KURDISH, "Kurdish", "ku" },
		{ LANGID_LAO, "Lao", "lo" },
		{ LANGID_LATIN, "Latin", "la" },
		{ LANGID_LATVIAN, "Latvian", "lv" },
		{ LANGID_LIMBURGAN, "Limburgan", "li" },
		{ LANGID_LINGALA, "Lingala", "ln" },
		{ LANGID_LITHUANIAN, "Lithuanian", "lt" },
		{ LANGID_LUBAKATANGA, "Lubakatanga", "lu" },
		{ LANGID_LUXEMBOURGISH, "Luxembourgish", "lb" },
		{ LANGID_MACEDONIAN, "Macedonian", "mk" },
		{ LANGID_MALAGASY, "Malagasy", "mg" },
		{ LANGID_MALAY, "Malay", "ms" },
		{ LANGID_MALAYALAM, "Malayalam", "ml" },
		{ LANGID_MALTESE, "Maltese", "mt" },
		{ LANGID_MANX, "Manx", "gv" },
		{ LANGID_MAORI, "Maori", "mi" },
		{ LANGID_MARATHI, "Marathi", "mr" },
		{ LANGID_MARSHALLESE, "Marshallese", "mh" },
		{ LANGID_MONGOLIAN, "Mongolian", "mn" },
		{ LANGID_NAURU, "Nauru", "na" },
		{ LANGID_NAVAJO, "Navajo", "nv" },
		{ LANGID_NORTHNDEBELE, "Northndebele", "nd" },
		{ LANGID_SOUTHNDEBELE, "Southndebele", "nr" },
		{ LANGID_NDONGA, "Ndonga", "ng" },
		{ LANGID_NEPALI, "Nepali", "ne" },
		{ LANGID_NORWEGIAN, "Norwegian", "no" },
		{ LANGID_NORWEGIANBOKMAL, "Norwegianbokmal", "nb" },
		{ LANGID_NORWEGIANNYNORSK, "Norwegiannynorsk", "nn" },
		{ LANGID_OCCITAN, "Occitan", "oc" },
		{ LANGID_OJIBWA, "Ojibwa", "oj" },
		{ LANGID_ORIYA, "Oriya", "or" },
		{ LANGID_OROMO, "Oromo", "om" },
		{ LANGID_OSSETIAN, "Ossetian", "os" },
		{ LANGID_PALI, "Pali", "pi" },
		{ LANGID_PASHTO, "Pashto", "ps" },
		{ LANGID_PERSIAN, "Persian", "fa" },
		{ LANGID_PORTUGUESE, "Portuguese", "pt" },
		{ LANGID_PUNJABI, "Punjabi", "pa" },
		{ LANGID_QUECHUA, "Quechua", "qu" },
		{ LANGID_ROMANIAN, "Romanian", "ro" },
		{ LANGID_ROMANSH, "Romansh", "rm" },
		{ LANGID_RUNDI, "Rundi", "rn" },
		{ LANGID_SAMI, "Sami", "se" },
		{ LANGID_SAMOAN, "Samoan", "sm" },
		{ LANGID_SANGO, "Sango", "sg" },
		{ LANGID_SANSKRIT, "Sanskrit", "sa" },
		{ LANGID_SARDINIAN, "Sardinian", "sc" },
		{ LANGID_SERBIAN, "Serbian", "sr" },
		{ LANGID_SHONA, "Shona", "sn" },
		{ LANGID_SINDHI, "Sindhi", "sd" },
		{ LANGID_SINHALA, "Sinhala", "si" },
		{ LANGID_SLOVAK, "Slovak", "sk" },
		{ LANGID_SLOVENIAN, "Slovenian", "sl" },
		{ LANGID_SOMALI, "Somali", "so" },
		{ LANGID_SOUTHERNSOTHO, "Southernsotho", "st" },
		{ LANGID_SUNDANESE, "Sundanese", "su" },
		{ LANGID_SWAHILI, "Swahili", "sw" },
		{ LANGID_SWATI, "Swati", "ss" },
		{ LANGID_TAGALOG, "Tagalog", "tl" },
		{ LANGID_TAHITIAN, "Tahitian", "ty" },
		{ LANGID_TAJIK, "Tajik", "tg" },
		{ LANGID_TAMIL, "Tamil", "ta" },
		{ LANGID_TATAR, "Tatar", "" },
		{ LANGID_TELUGU, "Telugu", "te" },
		{ LANGID_THAI, "Thai", "th" },
		{ LANGID_TIBETAN, "Tibetan", "bo" },
		{ LANGID_TIGRINYA, "Tigrinya" "ti" },
		{ LANGID_TONGA, "Tonga", "to" },
		{ LANGID_TSONGA, "Tsonga", "ts" },
		{ LANGID_TSWANA, "Tswana", "tn" },
		{ LANGID_TURKISH, "Turkish", "tr" },
		{ LANGID_TURKMEN, "Turkmen", "tk" },
		{ LANGID_TWI, "Twi", "tw" },
		{ LANGID_UIGHUR, "Uighur", "ug" },
		{ LANGID_URDU, "Urdu", "ur" },
		{ LANGID_UZBEK, "Uzbek", "uz" },
		{ LANGID_VENDA, "Venda", "ve" },
		{ LANGID_VIETNAMESE, "Vietnamese", "vi" },
		{ LANGID_VOLAPUK, "Volapuk", "vo" },
		{ LANGID_WALLOON, "Walloon", "wa" },
		{ LANGID_WELSH, "Welsh", "cy" },
		{ LANGID_WOLOF, "Wolof", "wo" },
		{ LANGID_XHOSA, "Xhosa", "xh" },
		{ LANGID_SICHUANYI, "Sichuanyi", "ii" },
		{ LANGID_YIDDISH, "Yiddish", "yi" },
		{ LANGID_YORUBA, "Yoruba", "yo" },
		{ LANGID_ZHUANG, "Zhuang", "za" },
		{ LANGID_ZULU, "Zulu", "zu" }
	};
